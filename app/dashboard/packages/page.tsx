...
const packageTypes = [
  { name: '5 Therapy Sessions', sessions: 5, duration: 90 },
  { name: '10 Wellness Checks', sessions: 10, duration: 180 },
  { name: '3 Consultation Package', sessions: 3, duration: 60 },
  { name: '8 Follow-up Sessions', sessions: 8, duration: 120 },
];

export default function PackagesInProgressPage() {
