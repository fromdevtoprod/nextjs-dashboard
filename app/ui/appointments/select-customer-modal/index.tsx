...
export function SelectCustomerModal({
  ...
  const handleAction = () => {
    onAction();
    router.push(
      `/dashboard/appointments/book?time=${time}&customerId=${selectedCustomerId}&productType=${selectedProductType}&date=${date}`,
    );
  };
        ...
        <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          ...
          >
            ...
            <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
              <BookButton
                isDisabled={
                  !time || !selectedCustomerId || !selectedProductType
                }
